...
const int SLOTS_ON_DISK = 24;   // disk's slot count
uint32_t last_tick = 0;         // For timeout logic
uint8_t min_rpm = 5;			// minimum rpm to look for, for timeout logic
...
int main(void)
{
  ...
  float timeout_ms = 60000.0f / (min_rpm * SLOTS_ON_DISK);
